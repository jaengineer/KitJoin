...
import com.jaengineer.kitjoin.AnimationCompat.ViewProxy;
...
public class ActionBarMenuItem extends FrameLayoutFixed {
    ...
    private int menuHeight = Utilities.dp(16);
    ...
    public boolean onTouchEvent(MotionEvent event) {
        if (event.getActionMasked() == MotionEvent.ACTION_DOWN) {
            if (hasSubMenu() && (popupWindow == null || popupWindow != null && !popupWindow.isShowing())) {
                ...
                Utilities.runOnUIThread(showMenuRunnable, 200);
            }
    ...
    public void toggleSubMenu() {
        ...
        if (showMenuRunnable != null) {
            Utilities.cancelRunOnUIThread(showMenuRunnable);
        ...
        if (popupWindow == null) {
            popupWindow = new ActionBarPopupWindow(popupLayout, layoutUtils.WRAP_CONTENT, layoutUtils.WRAP_CONTENT);
            ...
            popupLayout.measure(View.MeasureSpec.makeMeasureSpec(Utilities.dp(1000), View.MeasureSpec.AT_MOST), View.MeasureSpec.makeMeasureSpec(Utilities.dp(1000), View.MeasureSpec.AT_MOST));
    ...
    public ActionBarMenuItem setIsSearchField(boolean value, boolean needClearButton) {
        ...
        if (value && searchContainer == null) {
            ...
            if (android.os.Build.VERSION.SDK_INT < 11) {
                searchField.setOnCreateContextMenuListener(new View.OnCreateContextMenuListener() {
            ...
            layoutParams2.width = layoutUtils.MATCH_PARENT;
            layoutParams2.gravity = Gravity.CENTER_VERTICAL;
            layoutParams2.height = Utilities.dp(36);
            layoutParams2.rightMargin = needClearButton ? Utilities.dp(48) : 0;
            ...
            if (needClearButton) {
                ...
                layoutParams2.width = Utilities.dp(48);
                layoutParams2.gravity = Gravity.CENTER_VERTICAL | Gravity.RIGHT;
                layoutParams2.height = layoutUtils.MATCH_PARENT;
    ...
    private void updateOrShowPopup(boolean show, boolean update) {
        ...
        if (showFromBottom) {
            getLocationOnScreen(location);
            int diff = location[1] - Utilities.statusBarHeight + getMeasuredHeight() - menuHeight;
            offsetY = -menuHeight;
            if (diff < 0) {
                offsetY -= diff;
            }
        ...
        if (subMenuOpenSide == 0) {
            ...
            if (show) {
                popupWindow.showAsDropDown(this, -Utilities.dp(8), offsetY);
            }
            if (update) {
                popupWindow.update(this, -Utilities.dp(8), offsetY, -1, -1);
            }
        }
    }
