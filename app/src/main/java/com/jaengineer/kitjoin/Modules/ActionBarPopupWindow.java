...
public class ActionBarPopupWindow extends PopupWindow {
    ...
    public static class ActionBarPopupWindowLayout extends FrameLayout {
        ...
        public ActionBarPopupWindowLayout(Context context) {
            ...
            setPadding(Utilities.dp(8), Utilities.dp(8), Utilities.dp(8), Utilities.dp(8));
            setWillNotDraw(false);

            scrollView = new ScrollView(context);
            scrollView.setVerticalScrollBarEnabled(false);
            addView(scrollView, layoutUtils.createFrame(layoutUtils.WRAP_CONTENT, layoutUtils.WRAP_CONTENT));
        ...
        public void setBackScaleY(float value) {
            ...
            if (animationEnabled) {
                ...
                int height = getMeasuredHeight() - Utilities.dp(16);
                if (showedFromBotton) {
                    for (int a = lastStartedChild; a >= 0; a--) {
                        ...
                        if (position != null && height - (position * Utilities.dp(48) + Utilities.dp(32)) > value * height) {
                            break;
                        }
                    ...
                    for (int a = lastStartedChild; a < count; a++) {
                        ...
                        Integer position = positions.get(child);
                        if (position != null && (position + 1) * Utilities.dp(48) - Utilities.dp(24) > value * height) {
                            break;
                        }
                        lastStartedChild = a + 1;
                        startChildAnimation(child);
        ...
        private void startChildAnimation(View child) {
            if (animationEnabled) {
                ...
                animatorSet.playTogether(
                        ...
                        ObjectAnimator.ofFloat(child, "translationY", Utilities.dp(showedFromBotton ? 6 : -6), 0));
    ...
    public void dismiss(boolean animated) {
        if (animationEnabled && animated) {
            ...
            windowAnimatorSet = new AnimatorSet();
            windowAnimatorSet.playTogether(
                    ObjectAnimator.ofFloat(content, "translationY", Utilities.dp(content.showedFromBotton ? 5 : -5)),
